...
session.file.put("AOC22_example.txt", "@aoc_files_stage", auto_compress=False, overwrite=True)
session.file.put("AOC22_input.txt", "@aoc_files_stage", auto_compress=False, overwrite=True)
...
@sproc(is_permanent=True, 
       ...
       imports=['AOC22_part1_part2.py'])
def AOC22(session: Session, fileurl: str) -> str:
    from snowflake.snowpark.files import SnowflakeFile
    from AOC22_part1_part2 import Part1Part2
    ...
    part1_answer = _Part1Part2.part1(2000)

    # call the part2() module to solve Part 2
    part2_answer = _Part1Part2.part2(2000)

    return_msg = f"Part 1 answer = {part1_answer}\nPart 2 answer = {part2_answer}"
    return return_msg

lines_df = session.sql("""call AOC22(build_scoped_file_url(@aoc_files_stage, 'AOC22_input.txt'))""")
lines_df.show()

# to test locally, comment the previous two lines and the sproc decorator
#print(AOC22(session, 'AOC22_input.txt'))
