...
def AOC14(session: Session, fileurl: str) -> str:
    from snowflake.snowpark.files import SnowflakeFile
    from AOC14_part1_part2 import Part1Part2
    ...
    _Part1Part2 = Part1Part2(lines, 101, 103)
...
lines_df = session.sql("""call AOC14(build_scoped_file_url(@aoc_files_stage, 'AOC14_input.txt'))""")
lines_df.show()

# to test locally, comment the previous two lines and the sproc decorator
#print(AOC14(session, 'AOC14_input.txt'))
