...
session.file.put("AOC18_example.txt", "@aoc_files_stage", auto_compress=False, overwrite=True)
session.file.put("AOC18_input.txt", "@aoc_files_stage", auto_compress=False, overwrite=True)
...
@sproc(is_permanent=True, 
       ...
       imports=['AOC18_part1_part2.py'])
def AOC18(session: Session, fileurl: str) -> str:
    from snowflake.snowpark.files import SnowflakeFile
    from AOC18_part1_part2 import Part1Part2
    ...
    # different parameters when executing the example or my input
    _Part1Part2 = Part1Part2(lines, (6, 6), 12)
    #_Part1Part2 = Part1Part2(lines, (70, 70), 1024)
...
lines_df = session.sql("""call AOC18(build_scoped_file_url(@aoc_files_stage, 'AOC18_example.txt'))""")
lines_df.show()

# to test locally, comment the previous two lines and the sproc decorator
#print(AOC18(session, 'AOC18_input.txt'))
